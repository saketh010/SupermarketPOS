...
def reset_sales():
    try:
        ...
        lf2_entry_unlisted_fruit.delete(0, END)
...
def total_sales():
    ...
    if check_btn_var10.get() == 1:
        chickoo_results = int(menu_opt_var10.get()) * price_tag["chickoo"]
        chickoo_tuple = ("chickoo", str(menu_opt_var10.get()), "50")
        items_quantity_price.append(chickoo_tuple)
    else:
        chickoo_results = 0
    ...
    if check_btn_var12.get() == 1:
        pepinomelon_results = int(menu_opt_var12.get()) * price_tag["jackfruit"]
        pepino_melon_tuple = ("jackfruit", str(menu_opt_var12.get()), "30")
    ...
    try:
        ...
        total_cost_of_fruits = (mango_results + orange_results + apple_results + banana_results + watermelon_results +
                                ...
                                chickoo_results + pear_results + pepinomelon_results + other_item_results
                                )

        entry_cost_fruits.delete(0, END)
        entry_cost_fruits.insert(0, "Rs. " + str(total_cost_of_fruits))
    except NameError:
        error_handling("error!")
    except ValueError:
    ...
    juice_price_tag = {"toothbrush": 150, "toothpaste": 150, "pen": 100, "pencil": 200,
                       "notebook": 100, "potato_chips": 200, "milk": 100, "coffee": 200,
                       "tea": 250, "deodorant": 100, "tissue": 180, "mat": 200,
                       "unlisted_product": entry_price_unlisted_product_var.get()}

    if lf2_check_btn_var1.get() == 1:
        x1 = int(lf2_menu_opt_var1.get()) * juice_price_tag["toothbrush"]
        virgin_punch_tuple = ("toothbrush", str(lf2_menu_opt_var1.get()), "150")
        items_quantity_price.append(virgin_punch_tuple)
    else:
        x1 = 0

    if lf2_check_btn_var2.get() == 1:
        x2 = int(lf2_menu_opt_var2.get()) * juice_price_tag["toothpaste"]
        grape_nectar_tuple = ("toothpaste", str(lf2_menu_opt_var2.get()), "150")
        items_quantity_price.append(grape_nectar_tuple)
    else:
        x2 = 0

    if lf2_check_btn_var3.get() == 1:
        x3 = int(lf2_menu_opt_var3.get()) * juice_price_tag["pen"]
        plum_ness_tuple = ("pen", str(lf2_menu_opt_var3.get()), "100")
        items_quantity_price.append(plum_ness_tuple)
    else:
        x3 = 0

    if lf2_check_btn_var4.get() == 1:
        x4 = int(lf2_menu_opt_var4.get()) * juice_price_tag["pencil"]
        pencil_tuple = ("pencil", str(lf2_menu_opt_var4.get()), "200")
        items_quantity_price.append(pencil_tuple)
    else:
        x4 = 0

    if lf2_check_btn_var5.get() == 1:
        x5 = int(lf2_menu_opt_var5.get()) * juice_price_tag["notebook"]
        notebook_tuple = ("notebook", str(lf2_menu_opt_var5.get()), "100")
        items_quantity_price.append(notebook_tuple)
    else:
        x5 = 0

    if lf2_check_btn_var6.get() == 1:
        x6 = int(lf2_menu_opt_var6.get()) * juice_price_tag["potato_chips"]
        potato_chips_tuple = ("potato_chips", str(lf2_menu_opt_var6.get()), "200")
        items_quantity_price.append(potato_chips_tuple)
    else:
        x6 = 0

    if lf2_check_btn_var7.get() == 1:
        x7 = int(lf2_menu_opt_var7.get()) * juice_price_tag["milk"]
        milk_tuple = ("milk", str(lf2_menu_opt_var7.get()), "100")
        items_quantity_price.append(milk_tuple)
    else:
        x7 = 0

    if lf2_check_btn_var8.get() == 1:
        x8 = int(lf2_menu_opt_var8.get()) * juice_price_tag["coffee"]
        coffee_tuple = ("coffee", str(lf2_menu_opt_var8.get()), "200")
        items_quantity_price.append(coffee_tuple)
    else:
        x8 = 0

    if lf2_check_btn_var9.get() == 1:
        x9 = int(lf2_menu_opt_var9.get()) * juice_price_tag["tea"]
        tea_tuple = ("tea", str(lf2_menu_opt_var9.get()), "250")
        items_quantity_price.append(tea_tuple)
    else:
        x9 = 0

    if lf2_check_btn_var10.get() == 1:
        x10 = int(lf2_menu_opt_var10.get()) * juice_price_tag["deodorant"]
        deodorant_tuple = ("deodorant", str(lf2_menu_opt_var10.get()), "100")
        items_quantity_price.append(deodorant_tuple)
    else:
        x10 = 0

    if lf2_check_btn_var11.get() == 1:
        x11 = int(lf2_menu_opt_var11.get()) * juice_price_tag["tissue"]
        tissue_tuple = ("tissue", str(lf2_menu_opt_var11.get()), "180")
        items_quantity_price.append(tissue_tuple)
    else:
        x11 = 0

    if lf2_check_btn_var12.get() == 1:
        x12 = int(lf2_menu_opt_var12.get()) * juice_price_tag["mat"]
        mat_tuple = ("mat", str(lf2_menu_opt_var12.get()), "200")
        items_quantity_price.append(mat_tuple)
    else:
        x12 = 0

    try:
        global x13
        if lf2_entry_unlisted_fruit.get():
            x13 = int(lf2_menu_opt_var13.get()) * int(entry_price_unlisted_product_var.get())
            unlisted_product_tuple = (lf2_entry_unlisted_fruit.get(), str(lf2_menu_opt_var13.get()),
                                 entry_price_unlisted_product_var.get())
            items_quantity_price.append(unlisted_product_tuple)
        else:
            x13 = 0
        ...
        entry_cost_juice.delete(0, END)
        entry_cost_juice.insert(0, "Rs. " + str(total_cost_of_juice))

        entry_total_cost.delete(0, END)
        entry_total_cost.insert(0, "Rs. " + str(total_cost_of_juice + total_cost_of_fruits))

        tax_on_all_items = 0.16 * (total_cost_of_fruits + total_cost_of_juice)

        tax_entry.delete(0, END)
        tax_entry.insert(0, "Rs. " + str(tax_on_all_items))

        subtotal_entry.delete(0, END)
        subtotal_entry.insert(0, "Rs. " + str(total_cost_of_juice + total_cost_of_fruits))

        total_entry.delete(0, END)
        total_entry.insert(0, "Rs. " + str(total_cost_of_juice + total_cost_of_fruits + tax_on_all_items))
    except NameError:
        error_handling("error!")
    except ValueError:
        messagebox.showerror("Error!", "Price your items first, before finding the total.")
...
def print_receipt():
    try:
        receipt_field.delete("1.0", END)
        receipt_field.insert(END, "  Super Saver Mart." + "\n")
...
def today_report():
    ...
    receipt_field.delete("1.0", END)
    receipt_field.insert(END, "Super Saver Mart.          " + today2 + "." + "\n")
    receipt_field.insert(END, "  " + "\n")
    receipt_field.insert(END, "         ***TODAY\'S REPORT.***" + "\n")
    receipt_field.insert(END, "  " + "\n")
    receipt_field.insert(END, "Total Amount generated today: " + "Rs. " + str(answer1) + "\n")
    receipt_field.insert(END, "  " + "\n")
    receipt_field.insert(END, "Total V.A.T generated today: " + "Rs. " + str(answer2) + "\n")
    receipt_field.insert(END, "  " + "\n")
    receipt_field.insert(END, "Gross income + V.A.T: " + "Rs. " + str(answer1 + answer2) + "\n")
    receipt_field.insert(END, "  " + "\n")
...
# --------------------TITLE on top FRAME--------------------
title_label = Label(top_frame, text="Super Saver Mart.", font=("Aisha Latin Semibold", 20, "bold"), bg=color,
                    pady=10)
...
label_cost_juice = Label(right_frame, text="Cost of Grocery : ", font=("Aisha Latin Semibold", 10, "bold"), bg=color)
...
check_btn10 = Checkbutton(left_frame, text="Chickoo", variable=check_btn_var10)
...
check_btn12 = Checkbutton(left_frame, text="Jackfruit", variable=check_btn_var12)
check_btn12.place(x=3, y=335)

label_other_fruit = Label(left_frame, text="unlisted product :")
...
lf2_check_btn1 = Checkbutton(left_frame2, text="toothbrush", variable=lf2_check_btn_var1)
lf2_check_btn1.place(x=3, y=5)

lf2_check_btn_var2 = IntVar()
lf2_check_btn2 = Checkbutton(left_frame2, text="toothpaste", variable=lf2_check_btn_var2)
lf2_check_btn2.place(x=3, y=35)

lf2_check_btn_var3 = IntVar()
lf2_check_btn3 = Checkbutton(left_frame2, text="pen", variable=lf2_check_btn_var3)
lf2_check_btn3.place(x=3, y=65)

lf2_check_btn_var4 = IntVar()
lf2_check_btn4 = Checkbutton(left_frame2, text="pencil", variable=lf2_check_btn_var4)
lf2_check_btn4.place(x=3, y=95)

lf2_check_btn_var5 = IntVar()
lf2_check_btn5 = Checkbutton(left_frame2, text="notebook", variable=lf2_check_btn_var5)
lf2_check_btn5.place(x=3, y=125)

lf2_check_btn_var6 = IntVar()
lf2_check_btn6 = Checkbutton(left_frame2, text="potato_chips", variable=lf2_check_btn_var6)
lf2_check_btn6.place(x=3, y=155)

lf2_check_btn_var7 = IntVar()
lf2_check_btn7 = Checkbutton(left_frame2, text="milk", variable=lf2_check_btn_var7)
lf2_check_btn7.place(x=3, y=185)

lf2_check_btn_var8 = IntVar()
lf2_check_btn8 = Checkbutton(left_frame2, text="coffee", variable=lf2_check_btn_var8)
lf2_check_btn8.place(x=3, y=215)

lf2_check_btn_var9 = IntVar()
lf2_check_btn9 = Checkbutton(left_frame2, text="tea", variable=lf2_check_btn_var9)
lf2_check_btn9.place(x=3, y=245)

lf2_check_btn_var10 = IntVar()
lf2_check_btn10 = Checkbutton(left_frame2, text="deodorant", variable=lf2_check_btn_var10)
lf2_check_btn10.place(x=3, y=275)

lf2_check_btn_var11 = IntVar()
lf2_check_btn11 = Checkbutton(left_frame2, text="tissue", variable=lf2_check_btn_var11)
lf2_check_btn11.place(x=3, y=305)

lf2_check_btn_var12 = IntVar()
lf2_check_btn12 = Checkbutton(left_frame2, text="mat", variable=lf2_check_btn_var12)
lf2_check_btn12.place(x=3, y=335)

lf2_label_unlisted_fruit = Label(left_frame2, text="unlisted product :")
lf2_label_unlisted_fruit.place(x=3, y=390)

lf2_entry_unlisted_fruit = Entry(left_frame2, width=10)
lf2_entry_unlisted_fruit.place(x=100, y=390)
...
entry_price_unlisted_product_var = StringVar()
entry_price_unlisted_product = Entry(bottom_frame, textvariable=entry_price_unlisted_product_var, width=10)
entry_price_unlisted_product.place(x=405, y=5)
